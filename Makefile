...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-databricks_v1.38.0
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/databrickss/01-delete.yaml.tmpl.
